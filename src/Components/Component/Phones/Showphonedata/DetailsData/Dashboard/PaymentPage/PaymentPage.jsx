...
const PaymentPage = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto p-4 sm:p-6 space-y-6">
      <h2 className="text-2xl sm:text-3xl font-bold mb-4">Payment Page</h2>
      ...
      <div className="bg-gray-50 rounded-xl shadow-md p-4 sm:p-6">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
          ...
          >
            <img src="/icons/bkash.svg" alt="bKash" className="w-8 h-8" />
          ...
          >
            <img src="/icons/nagad.svg" alt="Nagad" className="w-8 h-8" />
          ...
          >
            <img src="/icons/rocket.svg" alt="Rocket" className="w-8 h-8" />
